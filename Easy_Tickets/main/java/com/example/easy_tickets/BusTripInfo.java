...
public class BusTripInfo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.bustrip_info, container, false);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    result=obj.BookBusTrip(cust_id,Bus_tripid,Integer.parseInt(seats.getText().toString()));
